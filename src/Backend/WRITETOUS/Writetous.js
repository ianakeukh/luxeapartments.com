...
class Contactform extends React.Component {
    ...
    state = {
        form: {
            ...
            phone: '+380670000000',
            company: 'ФОП Иванова Ю.А.',
            message: 'Хочу зробити замовлення, передзвоніть мені.',
            'send-telegram':1,
        },
        alert: ''
    }
            ...
            <div>
                <div className='container  justify-content-center m-auto pb-5 contacts w-100'>
                    <div className='price w-100 m-auto justify-content-center'>
                        <h3 className='h3-responsive  pt-3 pt-sm-5 mb-0 pb-3 pb-md-5 pb-xl-5 pb-lg-5 font-weight-bold text-center'>Форма зв'язку</h3>
