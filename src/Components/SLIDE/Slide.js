                            ...
                            <MDBCarouselItem itemId="1">
                                <MDBView className="position-relative">
                                    ...
                                    <div className='slide-info position-absolute w-100'>
                                        ...
                                        <h2 className='w-50 justify-content-center m-auto white-ic text-center slide-title'>Найкращі квартири Одеси. <br/>
                                            <span>
                                                Житло у портовому місті для задоволення Ваших потреб та відпочинку.
                                            </span>
                                        </h2>
                                        <div>
                                            <Link to='/about'>
